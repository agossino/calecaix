    ...
    <div class="container-xl mco">
        <div class="row justify-content-center">
            <div class="grid-containerx">
                ...
                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/1') }}">
                ...
                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/10') }}">
                            <div class="tit-testo">Trekking Fuori Porta</div>
                            <label>Trekking sulle colline di Bologna - Consulta dell'escursionismo </label>
                            <img class="ima" src="img/trekking-attivita.webp"
                                alt="Eventi cai">
                        </a></li>
                </div>
                ...
                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/2') }}">
                            ...
                            <img class="ima" src="img/corsi3.webp"
                                alt="Corsi CAI Image">
                        </a></li>
                </div>

                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/3') }}">
                            <div class="tit-testo">Alpinismo Giovanile</div>
                            <label>Riservato ai ragazzi</label>
                            <img class="ima" src="img/ag_logo.jpg"
                                alt="Alpinismo giovanile">
                        </a></li>
                </div>
                ...
                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/3') }}">
                            ...
                            <label>Trekking di piu giorni nel mondo</label>
                            <img class="ima" src="img/gtrek3.png"
                                alt="Grandi Trekking">
                        </a></li>
                </div>

                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/5') }}">
                            <div class="tit-testo">Grandi Trekking Residenziali</div>
                            <label>Trekking nel mondo ma con unico soggiorno</label>
                            <img class="ima"
                                src="img/gtrek4.png" alt="Grandi Trekking Residenziali">
                        </a></li>
                </div>

                {{-- <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/6') }}">
                            <div class="tit-testo">Trekking col Treno</div><img class="ima" src="img/trt.jpg"
                                alt="Trekking col Treno">
                        </a></li>
                </div> --}}

                <div class="grid-item">
                    <li> <a class="btn  btn-sm" href="{{ url('/attivita/index/' . $dataOggi . '/4') }}">
