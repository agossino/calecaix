...
<style>
    ...
    button.btn.btn-link {
        ...
        /* nasconde bottone homeattivita */
        a.btn.btn-primary.btn-sm.homeattivita {
    display: none;
}
</style>
        ...
        <div id="main">
            ...
            <div class="ciao">
                <button onclick="animateImage()">
                    <img id="mascotte" src="img/mascotte2b.png"
                        style="position: absolute; top: 125px; left: 45%;width:40px;" data-bs-toggle="modal" data-bs-target="#myModal"></button>
            ...
            <div class="container-xl">
                ...
                <x-menu-bar>
                    ...
                    <li class="l"><a class="btn btn-primary btn-sm" href="{{ url('https://caibo.it') }}">Home
                            Caibo.it</a></li>
                ...
                <div class="row">
                    <h2 style="text-align:center;font-weight:700;color:darkgreen;">Attività per tipologia</h2>
                </div>
                <div class="row">
                    @include('parziali.main')
                </div>
                <div class="row">
