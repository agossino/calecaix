                ...
                <div class="row">
                    <div class="col-md-6 co">
                        <form method="POST" action="{{ url("/attivita/save_edit/{$attivita->id}") }}"
                            ...
                            @csrf
                            <input type="hidden" name="tipo_volantino" value="{{1}}">
                            <div class="col-sm">
                                <br>
                                <!-- tipo volantino -->
                                <div style="border:solid 1px #ccc; padding:10px; margin:10px;">
                                    <label><span
                                        style="font-weight:700">Esterno</span>
                                   E' un volantino creato con tutte le informazioni e caricato su di un server esterno</label>
                                <br>
                                ...
                                <label>Inserire il link pdf esterno</label>
                                <input type="text" class="form-control" name="link_volantino"
                                    value="{{ $attivita->link_volantino }}">
                                ...
                                <!-- Published -->
                                <label class="lab">Stato</label><br>
